    ...
    override fun onCreatePreferences(
            ...
            onPreferenceClickListener =
                Preference.OnPreferenceClickListener {
                    ...
                    MaterialAlertDialogBuilder(activity)
                        .setTitle(R.string.preference_language_dialog_title)
                        .setSingleChoiceItems(localeLabels, currentLanguagePreference) { dialog, which ->
                            if (which == 0) {
                                ...
                                AppCompatDelegate.setApplicationLocales(
                                    LocaleListCompat.create(availableLocales[localeLabels[which]]),
                                )
                            }
                            dialog.dismiss()
                        }
        ...
        dragAndDropPref?.onPreferenceClickListener =
            Preference.OnPreferenceClickListener {
                ...
                MaterialAlertDialogBuilder(activity)
                    .setTitle(R.string.drag_and_drop_preference)
                    .setSingleChoiceItems(dragToMoveArray, currentDragPreference) { dialog, which ->
                        activity.prefs.edit()
