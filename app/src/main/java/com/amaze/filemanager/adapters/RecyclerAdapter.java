...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
  ...
  public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder vholder, int position) {
    ...
    // The per-item overflow button must use neutral touch feedback even under Monet, where
    // AppCompat can otherwise apply the dark accent as an internal background tint.
    holder.about.setSupportBackgroundTintList(null);
    holder.about.setBackgroundResource(R.drawable.ripple_overflow_neutral);
